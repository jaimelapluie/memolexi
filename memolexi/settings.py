"""
Django settings for memolexi project.
...
SECRET_KEY = 'django-insecure-t$!fovwre_6&k%1!pal3c&l^3$+8d+o@ni3_y^jui=6&ziv)t9'
...
WSGI_APPLICATION = 'memolexi.wsgi.application'
